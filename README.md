...
> Answer: 
    Client side routing allows you access and view data without having to reload your whole website.
...
> Answer:
    Controlled components are components that can be changed by the value of the state.
